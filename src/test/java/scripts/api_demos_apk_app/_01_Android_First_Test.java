...
public class _01_Android_First_Test extends Base {
     ...
     * 6. Validate that the Wi-Fi settings checkbox is enabled.
     */
    @Test
     ...
     * 3. Tap on the "Animation" option.
     * 4. Tap on the "Shake" option.
     * 5. Validate that the input box is displayed.
     */
    @Test
    public void demoShakeInputBox(){
        ElementActions.clickOnElementInAList(apiDemosLandingPage.mainMenuItems, "Views");
        ElementActions.clickOnElement(apiDemosViewsPage.animationButton);
        ElementActions.clickOnElement(apiDemosViewsPage.shakeButton);
        Assert.assertTrue(apiDemosViewsPage.inputBox.isDisplayed());
    }
}
